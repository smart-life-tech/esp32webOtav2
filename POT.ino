...
{
#ifdef SERIAL_DEBUG_INTERFACE_PRINT
  Serial.println("POT SET method got Called with Set Value:");
  Serial.println(required_val);
#endif
...
#ifdef SERIAL_DEBUG_INTERFACE_PRINT
  Serial.println("POT SET method execution Over with memorize_last_POT_val:");
  Serial.println(memorize_last_POT_val);
#endif
}
